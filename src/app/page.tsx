      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            jobTitle: "Frontend Lead & Full Stack Developer",
            worksFor: {
              "@type": "Organization",
              name: "CodeRabbit",
      ...
      <section id="contributions">
        <div className="space-y-12 w-full py-12">
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed max-w-2xl">
                  ...
                  From AI-powered platforms to enterprise applications, each project 
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 max-w-4xl mx-auto">
            {DATA.contributions.slice(0, 4).map((project, id) => (
              <BlurFade
                key={project.title}
